    ...
    public InboundResponse invokeService(InboundRequest request)
    {
        ...
        if (registry == null)
        {
            ...
            return InboundResponse.createBuilder()
                    ...
                    .transactionState(TransactionState.TX_ACTIVE)
                    .build();
        }

        CasualQuarkusServiceRegistry.ServiceEntry serviceEntry = registry.getService(serviceName);
        ...
        try
        {
            ...
            Object beanInstance = serviceEntry.getBeanInstance();
            Method method = serviceEntry.getMethod();
